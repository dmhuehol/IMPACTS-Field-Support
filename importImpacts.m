...
%%importImpacts
    ...
    %
    %Version date: 2/06/2020
    %Last major revision: 2/06/2020
...
filenameForMeta = splitFilename{end};
date_string = filenameForMeta(19:30);
valid_date_num = datenum(date_string,'YYYYMMDDHH');
launch_site = filenameForMeta(32:34);
